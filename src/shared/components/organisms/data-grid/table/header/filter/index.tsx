  ...
  return (
    column?.columnDef?.meta?.filter && (
      <Tooltip
        ...
        content={
          <div
            className={classNames('flex flex-col gap-1 bg-base-0 p-2 text-base-800', {
            ...
            <div className="relative mt-1">
              ...
              <strong className="relative bg-base-0 py-1 pr-1">{t('ConditionSetting')}</strong>
            </div>
            <p>
            ...
            <div className="mt-1 flex gap-2">
              ...
              />
              <Button className="w-full" text={t('Apply')} handleClick={handleSubmit} />
            </div>
          </div>
        }
