...
All steps User
  ...
  Then Webpage should contain "Phone" input field
  Then Webpage should contain "Description" input field
  Then Webpage should contain "Update" button
  Then Webpage should contain "Back to List" button
  ...
  When Enter "text" in "Description" with ""
  ...
  When In the "Users" section
  When Click on the "Change Password" button in the "_@Username@_" line
  When In the "Change Password" section
  Then Webpage should contain "Password" input field
  When Click "Save" button
  Then Required message "Please enter password" displayed under "Password" field
  When Enter "text" in "Password" with "Password1!1"
  Then Data's information in "Password" should be equal "_@Password@_"
  When Click "Save" button
  Then Look message "Password has been changed successfully" in popup "Success"
